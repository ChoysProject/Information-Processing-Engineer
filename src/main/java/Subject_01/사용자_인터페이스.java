...
//		- VUI (Voice User Interface) : 사람의 음성으로 기기를 조직하는 인터페이스
...
//		- 유연성 : 사용자의 요구사항을 최대한 수용학 실수로 최소화 해야 함. 
//		# 직유학연
//	 
//	3) 웹 3요소
...
//	5) UI 프로토타입
//		- 장점 : 사용자를 설득하고 이해시키기 쉬움 개발 시간을 줄일 수 있음 사전오류 발견가능
//		- 단점 : 반복적인 개선 및 보완 작업으로 인한 작업 시간 증가 및 자원 ㅅ모 부분적인 프로토타이핑으로 인한 중요한 작업 생략 가능성
//		# 페이퍼 프로토 타입, 디지털 프로토 타입, HTML/CSS
...
//	7) 기타 
//		- HCI : 사람과 컴퓨터의 연구해서 사람이 컴퓨터를 편리하게 사용하도록 만드는 학문
//		- UX : 사용자가 시스템이나 서비스를 이용하면서 느끼는 총체적인 경험
//		# 주관성, 정확성, 총체성
//		
//		- 감성공학 : 1류 : 인간의 감성 / 2류 심리적 기능 / 3류 공학점 및 객관적
