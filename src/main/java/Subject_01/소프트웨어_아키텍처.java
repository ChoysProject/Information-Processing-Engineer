...
public class 소프트웨어_아키텍처 {

	
	// 소프트웨어 아키텍처
	
//	- 사용자의 비기능적 요구사항으로 나타난 제약 반영
//	- 기능적 요구사항을 구현하는 방법을 찾는 해결과정
//	# 모추단정
//	
//	1) 모듈화 
//		- 시스템 기능들을 모듈 단위로 나눠 소프트웨어의 성능 및 재사용성을 향상시키는 것.
//		- 모듈의 크기 다수 : 모듈 개수 적음/ 모듈 간 통합 비용 적음 / 모듈 하나의 개발 비용 큼
//		- 모듈크기 적음 : 모듈 개수 많음 / 모듈 간 통합 비용 많음 / 모듈 하나의 개발 비용 작음
...
//	3) 단계적 분해 
//		- Nikiaus Wirth에 의해 제안된 하향식 설계 전략
//		- 추상회의 반복에 의해 세분화
//		- 소프트웨어 기능에서부터 시작해 절차저으로 구체화
//		- 상세한 내역은 가능한 한 뒤로 미루어 진행
//		
//	4) 정보 은닉
//		- 한 몯ㄹ 내부에 포함된 절차의 자료들의 정보가 감추어져 다른 모듈이 접근하거나 변경하지 못하도록 하는 기법
//		- 정보 은닉을 통한 독립적 모듈 수행 기능
