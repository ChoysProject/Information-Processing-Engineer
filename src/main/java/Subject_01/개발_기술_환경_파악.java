...
public class 개발_기술_환경_파악 {

//	개발 기술 환경 파악 ★
	
//	1) 운영체제(OS: Operating System)
//	- 하드웨어가 아닌 소프트웨어
//	# Window, UNIX, Linux, Mac Os | IOS, 안드로이드 등
...
//	- JDBC (JAVA Database Connectivity), ODBC(Open Database Connectivity) 응용 프로그램
//	# Oracle, MySQL, SQLite, Redis 등
